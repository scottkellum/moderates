  ...
  def questions
    [
      Question.new(name: "What's your age range?", key: "age", options: [
        Option.new(name: "Under 25", value: "0,1,0"),
        Option.new(name: "Between 25 and 55", value: "1,0,0"),
        Option.new(name: "Older than 55", value: "0,0,1")
      ]),
      Question.new(name: "Describe your typical week:", key: "week", options: [
        Option.new(name: "That’s a more complicated question than you think it is", value: "2,0,0"),
        Option.new(name: "I meet some deadlines but mostly make it up.", value: "0,1,0"),
        Option.new(name: "Some appointments.", value: "0,0,3")
      ]),
      Question.new(name: "Describe how you spend your free time:", key: "freetime", options: [
        Option.new(name: "Aside from work or school, hang out with friends.", value: "0,1,0"),
        Option.new(name: "What free time? ", value: "2,0,0"),
        Option.new(name: "That’s an open question.", value: "0,0,3")
      ]),
      Question.new(name: "What's your organizational style?", key: "org", options: [
        Option.new(name: "Around school or work.", value: "0,1,0"),
        Option.new(name: "Super tight on time, so I try to stick to a schedule.", value: "2,0,0"),
        Option.new(name: "I have things pretty much in order.", value: "0,0,3")
      ]),
      Question.new(name: "What do you most crave from civic life?", key: "crave", options: [
        Option.new(name: "Change: immediately, now, for the future.", value: "0,1,0"),
        Option.new(name: "A slowdown on the news cycle, please.", value: "2,0,0"),
      ...
      Question.new(name: "What is something you feel like you don't have?", key: "lack", options: [
        ...
        Option.new(name: "I feel sort of out-of-the-loop.", value: "0,0,3")
      ]),
      Question.new(name: "What do you consider your biggest strength?", key: "strength", options: [
        Option.new(name: "I have a deep and strong network.", value: "2,0,0"),
